...
func TestInferencePerf(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "inference-perf Benchmark Suite")
}
...
var _ = Describe("inference-perf", func() {
	...
	Describe("Benchmark Execution", Label("quantitative"), func() {
		...
		It("should collect benchmark results", func() {
			...
			GinkgoWriter.Printf("=== inference-perf Results ===\n")
